...
<body>
    <h2>아이러브제주 서비스 이용약관</h2>
    <br>

    <h3>제 1 장 총 칙</h3>
    <h4>제1조 목적</h4>
    이 약관은 아이러브제주 서비스(이하 "서비스"라 합니다)의 이용과 관련하여 현행 법령에 위반하지 않는 범위 내에서 회원의 기본적인 권리와 책임 및 당사와의 중요사항을 정하는 것을 목적으로 합니다.<br>
    <br>
    <h4>제2조 용어의 정의</h4>
    ...
    - '회사','서비스제공자'란 ' 아이러브제주와 계약된 별도서비스 운영자를 뜻합니다.<br>
